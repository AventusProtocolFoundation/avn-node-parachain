...
pub fn avn_polkadot_config() -> Result<ChainSpec, String> {
	production::avn_polkadot_config()
}

/// Configuration of AvN parachain on Rococo network (Public Testnet).
pub fn avn_rococo_config() -> Result<ChainSpec, String> {
	production::avn_rococo_config_v5()
}
